...
<head>
  ...
  <meta property="og:image:alt" content="파란 알뜰이 아이콘과 검색 결과를 원하는 기준으로 정렬하고 정리하세요 문구">
  ...
  <meta name="twitter:image:alt" content="파란 알뜰이 아이콘과 검색 결과를 원하는 기준으로 정렬하고 정리하세요 문구">
  ...
  <style>
    ...
    * { box-sizing:border-box; }
    ...
    .wrap { max-width:900px; margin:0 auto; padding:32px max(20px,env(safe-area-inset-right)) max(64px,env(safe-area-inset-bottom)) max(20px,env(safe-area-inset-left)); }
    ...
    @media (max-width:600px) { .wrap { padding:16px max(16px,env(safe-area-inset-right)) max(40px,env(safe-area-inset-bottom)) max(16px,env(safe-area-inset-left)); } .hero,.card { padding:20px 16px; border-radius:10px; } }
...
<body>
  ...
  <div class="wrap">
    <header class="hero">
      <div class="brand"><img src="/icon128.png" alt="알뜰이 아이콘" width="44" height="44"><h1>알뜰이 법적 고지</h1></div>
      <p>알뜰이의 개인정보처리방침과 이용약관입니다.</p>
      <nav aria-label="법적 고지 탐색"><a href="/">소개 페이지</a><a href="#privacy">개인정보처리방침</a><a href="#terms">이용약관</a></nav>
    </header>
