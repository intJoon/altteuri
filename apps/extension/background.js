importScripts('lib/runtime-utils.js', 'lib/settings-defaults.js', 'lib/preset-data.js');
...
const ICON_INACTIVE = Object.freeze({
  16: 'assets/icons/icon16-gray.png',
  32: 'assets/icons/icon32-gray.png',
  48: 'assets/icons/icon48-gray.png'
});
