globalThis.ALT_BUILTIN_PRESET = {
  ...
  version: 8,
  items: [
    { selector: "div.coupang-top-banner", name: "검색결과 상단 배너", category: "srp", order: 1 },
    { selector: "#srpKeywordTopBanner", name: "검색어 상단 브랜드 배너", category: "srp", order: 2 },
    { selector: "#srpKeywordProductTopBanner", name: "검색어 맞춤 상품 광고", category: "srp", order: 3 },
    { selector: "#product-list > li:has(button[aria-label='Ad information'])", name: "검색결과 그리드 광고 상품", category: "srp", order: 4 },
    { selector: "li.best-seller", name: "최근 다른 고객이 많이 구매한 상품", category: "srp", order: 5 },
    { selector: "li.limited-time-offer", name: "한정 시간 특가 상품", category: "srp", order: 6 },
    { selector: "#srp-bottom-carousel-dco-container", name: "같이 보면 좋은 상품", category: "srp", order: 7 },
    { selector: "div.jikgu-promo", name: "전세계 핫딜 로켓직구 글로벌특가", category: "srp", order: 8 },
    { selector: "div.also-viewed", name: "이 상품을 검색한 다른 분들이 함께 본 상품", category: "srp", order: 9 },
    { selector: "div.todays-sale", name: "오늘의 판매자 특가", category: "srp", order: 10 },
